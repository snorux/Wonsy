...
namespace Wonsy.Attributes
{
    public class BotOwnerOnlyAttribute : PreconditionAttribute
    {
        public override Task<PreconditionResult> CheckRequirementsAsync(IInteractionContext context, ICommandInfo commandInfo, IServiceProvider services)
        {
            ...
            return Task.FromResult(isOwner ? PreconditionResult.FromSuccess() : PreconditionResult.FromError("You must be added to the \"BotOwners\" in the config.json to use this command"));
        }
    }
}
